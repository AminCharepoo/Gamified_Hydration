...
# -------- IMAGES SETUP -----------
happyCatIMG = framebuf.FrameBuffer(catHappy, 43, 32, framebuf.MONO_HLSB)
closedMouthCatIMG = framebuf.FrameBuffer(catClosed, 32, 32, framebuf.MONO_HLSB)
openMouthCatIMG = framebuf.FrameBuffer(catOpen, 32, 32, framebuf.MONO_HLSB)
...
# ---- IMAGE FUNCTIONS ----
def checkImageState():
    global catState, lastDisplayedCat, imgState
    if imgState == "Happy":
